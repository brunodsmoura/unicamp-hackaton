<div class="form-group">
	<label for="categoria" class="control-label col-lg-2"><g:message code="anuncio.categoria.label" default="Categoria" />*</label>
...
<div class="form-group">
	<label for="titulo" class="control-label col-lg-2"><g:message code="anuncio.titulo.label" default="Titulo" />*</label>
...
<div class="form-group">
	<label for="descricao" class="control-label col-lg-2"><g:message code="anuncio.descricao.label" default="Descricao" />*</label>
...
<div class="form-group">
	<label for="valorPrevisto" class="control-label col-lg-2"><g:message code="anuncio.valorPrevisto.label" default="Valor Previsto" /></label>
...
<div class="form-group">
	<label for="prazo" class="control-label col-lg-2"><g:message code="anuncio.prazo.label" default="Prazo" />*</label>
...
<div class="form-group">
	<label for="requisitos" class="control-label col-lg-2"><g:message code="anuncio.requisitos.label" default="Requisitos" />*</label>
